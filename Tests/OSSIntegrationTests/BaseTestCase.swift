...
struct RamRoleArnCredentialProvider: CredentialsProvider {
    ...
    public func getCredentials() async throws -> AlibabaCloudOSS.Credentials {
        ...
        params.append(URLQueryItem(name: "Timestamp", value: DateFormatter.iso8601DateTime.string(from: Date())))
        ...
        do {
            ...
            request.setValue(UserAgent.getDefault(), forHTTPHeaderField: "user-agent")
                ...
                if let accessKey = credentials["AccessKeyId"],
                   ...
                   let token = credentials["SecurityToken"] {
                    let credentials = Credentials(accessKeyId: accessKey,
                                                  ...
                                                  securityToken: token,
                                                  expiration: DateFormatter.iso8601DateTime.date(from: expirationTime))
                    return credentials
                }
            }
